...
def main_window(workq: Queue, ardq: Queue, guiq: Queue):
    ...
    layout = [[
        ...
        [
            sg.TabGroup([[
                ...
                sg.Tab("Acquisizione Dati", tab_dati.tab(88), key=Id.TAB2),
                sg.Tab("Calibrazione", tab_calibrazione.tab(88), key=Id.TAB3),
                sg.Tab("Verbale", tab_verbale.tab(88), key=Id.TAB4),
                sg.Tab("Terminale", tab_terminale.tab(88), key=Id.TAB5)
            ]],
                key=Id.MAINTAB,
                enable_events=True)
    ],
    ...
    m.needle1 = tab_informazioni.update_gauge_dir(None, window, 0)
    m.needle2 = tab_informazioni.update_gauge_rif(None, window, 0)
        ...
        try:
            ...
            msg.match(
                ...
                revision=lambda y: window[Id.REVISION].Update(
                    y.replace('\n', '\t')),
                power=lambda x, y, z: tab_informazioni.update_info(m,
