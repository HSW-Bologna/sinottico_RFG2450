...
def update_gauge_dir(window: sg.Window, value: int):
    window[Id.GAUGE_DIR].draw_line((0, 0), needle(
        value, radius=70, blind_angle=88), width=3)


def update_gauge_rif(window: sg.Window, value: int):
    window[Id.GAUGE_RIF].draw_line((0, 0), needle(
        value, radius=70, blind_angle=88), width=3)
